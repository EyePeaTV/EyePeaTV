...
set "playlist=%playlistDir%\bt-sport.m3u"
set "playlistTitle=Bt Sport"
set "playlistLogoURL=%assetsURL%/logos/bt-sport.png"
set "playlistURL=%assetsURL%/playlists/bt-sport.m3u"
