...
set "playlist=%playlistDir%\supersport.m3u"
set "playlistTitle=SuperSport"
set "playlistLogoURL=%assetsURL%/logos/supersport.png"
set "playlistURL=%assetsURL%/playlists/supersport.m3u"
