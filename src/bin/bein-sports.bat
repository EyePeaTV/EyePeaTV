...
set "playlist=%playlistDir%\bein-sports.m3u"
set "playlistTitle=beIN Sports"
set "playlistLogoURL=%assetsURL%/logos/bein-sports.png"
set "playlistURL=%assetsURL%/playlists/bein-sports.m3u"
